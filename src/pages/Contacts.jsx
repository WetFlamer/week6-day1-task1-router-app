    ...
    <div>
      <div>
        ...
        <p className="description-s">
          Service options: On-site services · No online classes 
          Address: ул.Геннадия Трошева, 7, 2 этаж, 6 кабинет, 
          Grozny, Chechnya, 364024
          Hours: Open ⋅Closes 6PM Phone: 8 (938) 904-85-33 
          Appointments: intocode.ru
        </p>
